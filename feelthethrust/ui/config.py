...
class ConfigFrame(ttk.Frame):
    def __init__(self,master,settings, machine, fullscreentoggle):
        ...
        self.targetForceLabel = ttk.Label(self, text="Target Force(N)",  anchor=tk.E)
        self.targetForceLabel.grid(row=8, column=0,sticky="e")
        self.targetForceVar = tk.StringVar()
        self.targetForceVar.set(self.settings.getValue("targetForce"))
        self.targetForceEntry = ttk.Entry(self, width=35, font=('Helvetica', 16),validate='key', validatecommand=self.vcmd, textvariable=self.targetForceVar)
        self.targetForceEntry.grid(row=8, column=1,sticky="w")
        self.targetForceEntry.bind('<FocusIn>', lambda event: self.setCurrentFocusElement(self.targetForceEntry, self.targetForceVar))

        self.baselineForceLabel = ttk.Label(self, text="Baseline Force(N)",  anchor=tk.E)
        self.baselineForceLabel.grid(row=9, column=0,sticky="e")
        self.baselineForceVar = tk.StringVar()
        self.baselineForceVar.set(self.settings.getValue("baselineForce"))
        self.baselineForceEntry = ttk.Entry(self, width=35, font=('Helvetica', 16),validate='key', validatecommand=self.vcmd, textvariable=self.baselineForceVar)
        self.baselineForceEntry.grid(row=9, column=1,sticky="w")
        self.baselineForceEntry.bind('<FocusIn>', lambda event: self.setCurrentFocusElement(self.baselineForceEntry, self.baselineForceVar))

        self.retractLabel = ttk.Label(self, text="Retraction (mm)",  anchor=tk.E)
        self.retractLabel.grid(row=10, column=0,sticky="e")
        ...
        self.retractEntry.grid(row=10, column=1,sticky="w")
        ...
        self.retractSpeedLabel.grid(row=11, column=0,sticky="e")
        ...
        self.retractSpeedEntry.grid(row=11, column=1,sticky="w")
        ...
        self.jogSpeedLabel.grid(row=12, column=0,sticky="e")
        ...
        self.jogSpeedEntry.grid(row=12, column=1,sticky="w")
        ...
        self.saveSettingsBtn = ttk.Button(self.numPadFrame, text="Save Config",command=self.saveConfig)
        self.saveSettingsBtn.grid(row=6, column=1, columnspan=2, sticky="nsew")

        self.homeBtn = ttk.Button(self.numPadFrame, text="Home Machine",command=self.homeMachine)
        self.homeBtn.grid(row=7, column=1, columnspan=2, sticky="nsew")
